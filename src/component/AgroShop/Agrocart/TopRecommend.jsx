...
function CartrecommendSlider(){
    ...
    return(
        <>
          <hr />
          <div className="home_products_sell recommend-sell">
            <h1 style={{letterSpacing: '0.75px',color: '#22262A', margin: "2rem"}}>TOP RECOMMENDED</h1>
          </div>
...
export default CartrecommendSlider;
